...
#define METER_LONG_MAX 13000.0f  // Don't forget the .0f at the end. Change it to whatever the amount of liters to show.
#define METER_SHORT_MAX 200.0f   // Second strand, this should be a lot lower so you can see progress
#define NUM_LEDS_LONG 65         // This is the amount of leds (or individual parts of the ledstrip) to control
